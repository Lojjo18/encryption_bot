module.exports = {
    ...
    execute(message, args){
        ...
        if(input.length != 0){
                            ...
                            if(`${m.first()}` == '+'){
                               for(i = 0; i < arr.length; i++){
                                ...
                                for(i = 0; i < arr.length; i++){
                                        ...
                                        ciph[i] = String.fromCharCode(ciph[i] + 97);
                            
                                }
                                message.author.send("Here's the result ciphertext according to the keys you've entered ready for copy:");
                                message.author.send(ciph.join(''));
                            }else if(`${m.first()}` == '-'){
                                for(i = 0; i < arr.length; i++){
                                    ciph[i] = (arr[i] - temp[i]);
                                }
            ...
            message.channel.send("Please enter the plaintext!");
        }
    }
